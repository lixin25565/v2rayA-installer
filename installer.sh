...
check_v2ray_remote_version() {
    ...
    v2ray_url="https://github.moeyy.xyz/https://github.com/v2fly/v2ray-core/releases/download/$v2ray_remote_version/v2ray-linux-$v2ray_arch.zip"
...
check_xray_remote_version() {
    ...
    xray_url="https://github.moeyy.xyz/https://github.com/XTLS/Xray-core/releases/download/$xray_remote_version/Xray-linux-$v2ray_arch.zip"
    rm -f "$xray_temp_file"
}
...
check_v2raya_remote_version() {
    ...
    v2raya_url="https://github.moeyy.xyz/https://github.com/v2rayA/v2rayA/releases/download/${v2raya_remote_version}/v2raya_linux_${v2raya_arch}_${v2raya_short_version}"
